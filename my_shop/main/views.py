    ...
    shops_data = [
        {
            ...
            "items": [
                ...
                for item in colourproduct.colourproductshop.select_related("shop")
                if item.quantity > 0
            ],
        }
        for colourproduct in product.colourproduct.select_related("colour")
    ]

    # Добавляем список цветов товара
    product_colour = product.colour.all()
